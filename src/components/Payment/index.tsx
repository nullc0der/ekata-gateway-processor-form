                ...
                <>
                    <QRCode
                        value={encodeURIComponent(
                            `${paymentData.currency_name}:${paymentData.wallet_address}?amount=${paymentData.amount_requested}`
                        )}
                        size={128}
                    />
                    <div className="text-center mt-4">
                        <p style={{ fontWeight: 'bold' }}>Send Payment</p>
                        <span>
                    ...
                    <div className="text-center mt-4">
                        <span className="me-2">Checking payment status</span>
                        <Spinner
                            animation="grow"
                            size="sm"
                            variant="secondary"
                    ...
                    <Overlay
                        ...
                        onHide={() => setShowAmountCopied(!showAmountCopied)}
                        rootClose={true}
                        placement="bottom">
                        {(props) => <Tooltip {...props}>Amount Copied</Tooltip>}
                    </Overlay>
                    <Overlay
                        target={addressCopiedTooltipTarget.current}
                        show={showAddressCopied}
                        onHide={() => setShowAddressCopied(!showAddressCopied)}
                        rootClose={true}
                        placement="bottom">
                        {(props) => (
